		...
		<div class="col-xl-12">
			<div class="card">
				...
				<div class="card-header pb-0">
						<span class="h2">مقاسات المنتج</span>
					

					<div style="display: flex;float: left; margin: 5px">

						<router-link to='create_size' class="tn btn-info btn-sm waves-effect btn-agregar" data-toggle="modal" id="agregar_productos"
							data-target="#addAb">
						...
						<table class="table text-md-nowrap" id="example1">
							...
							<tbody>
								<tr v-for="sizes in size">
									...
									<td>
										<button type='button' @click="delete_size(sizes.id)" class="btn btn-danger btn-sm"><i
												class="fa fa-trash"></i></button>
										<router-link :to="{ name: 'edit_size', params: { id: sizes.id } }"
